...
dir = os.path.join(dirs['dump_dir'], 'DW', 'CAIXA_PRE')
...
BANCO_ORIGEM = 'bd_bi_caixa_pre'
BANCO_DESTINO = 'cxg_db_caixa_pre'
CAMPO_DATA = 'data_cri'
TABELA_ALVO = 'tb_ativo_caixa_pre'
...
def update(dia)-> dict:
    ...
    TABELA_DESTINO = BANCO_DESTINO + '.' + TABELA_ALVO
    ARQUIVO = os.path.join(dir, f'{TABELA_ALVO}.csv')
    PRESTMT = f"CREATE TABLE IF NOT EXISTS {TABELA_DESTINO2} LIKE {TABELA_DESTINO}"
