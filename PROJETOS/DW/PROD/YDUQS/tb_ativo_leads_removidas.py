...
CAMPO_DATA = 'data_cri'
TABELA_ALVO = 'tb_ativo_leads_removidas'
...
def batch(dia)-> dict:
    ...
    # PRESTMT = f"SELECT 1"
    # AND = f"AND arq_cri = 'LEADS_PILOTO_ABANDONO_CARRINHO_KONECTA_MC_NORDESTE_20230517_1711.csv'"
    # AND = f"AND arq_cri = 'LEADS_PILOTO_ABANDONO_CARRINHO_KONECTA_MC_SP_ SUL_20230517_2207.csv'"
