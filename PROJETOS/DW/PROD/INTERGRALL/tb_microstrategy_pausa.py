...
from intergrall_mariadb import MariaDB
...
COLUNAS = ['*']
CAMPO_CHAVE = 'data_inicio'
BANCO_ORIGEM = 'bd_wr_planejamento_bi'
CHARINDEX = re.search('bd_wr_', BANCO_ORIGEM).end()
TABELA = 'tb_microstrategy_pausa'
REPRESENTANTE = BANCO_ORIGEM[CHARINDEX:].upper()
TABELA_ORIGEM  = BANCO_ORIGEM + '.' + TABELA
BANCO_DESTINO = 'dm_db_central_ponto'
