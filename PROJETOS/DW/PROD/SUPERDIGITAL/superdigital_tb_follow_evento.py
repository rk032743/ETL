...
dir = os.path.join(dirs['dump_dir'], 'DW', 'SUPERDIGITAL')
...
BANCO_ORIGEM = 'bd_bi_superdigital'
BANCO_DESTINO = 'cxg_db_superdigital'
CAMPO_DATA = 'data_cri'
TABELA_ALVO = 'tb_follow_evento'
